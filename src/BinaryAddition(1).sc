...
convertIntListToBooleanList(pList), convertIntListToBooleaList(qList)
...
convertBooleanListToIntList(reverseList(doBinaryAddition(reverseList(convertIntListToBooleanList(pList)), reverseList(convertIntListToBooleanList(qList)),false)))
